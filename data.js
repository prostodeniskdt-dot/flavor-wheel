// v21.12.8 dataset — taxonomy + sample FLAVOR_DATA
...
window.TAXONOMY = {
  ...
  "subgroups": {
    ...
    "Ром": ["White / Blanco","Gold / Amber","Dark","Aged (Añejo/Reserva)","Spiced","Overproof","Rhum Agricole Blanc","Rhum Agricole Vieux"],
    "Бренди/Коньяк": ["Коньяк — VS","Коньяк — VSOP","Коньяк — XO","Арманьяк — VS/VSOP","Арманьяк — XO/Hors d’Age","Испанский бренди — Reserva/Gran Reserva","Писко — Puro/Acholado/Mosto Verde","Кальвадос — Fine/VSOP/XO"],
    "Джин": ["London Dry","Old Tom","Plymouth","Navy Strength","Современный стиль (New Western)","Genever (Jenever)","Бочковой (Barrel-Aged)"]
  },
  "names": {
...
// Минимальный FLAVOR_DATA для демонстрации работы на группах/подгруппах/наименованиях
window.FLAVOR_DATA = {
  "Цитрусовые": {
    "notes": "Лимонен/цитраль. Любят зелень, крестоцветные, белую рыбу.",
    "best": [{"to":"Кинза","tip":"Терпены дружат с зеленью"},{"to":"Имбирь","tip":"Цитраль + гингерол"},{"to":"Белая рыба","tip":"Кислота чистит жирность"}],
    "good": [{"to":"Авокадо"},{"to":"Йогурт"}],
    "bad": [{"to":"Сильный дым"},{"to":"Молоко/Сливки без стабилизации"},{"to":"Горький хмель"}],
    "unexpected": [{"to":"Тмин"}]
  },
  "Лимоны": {
    "best": [{"to":"Имбирь"},{"to":"Мята"}],
    "good": [{"to":"Йогурт"}]
  },
  "Eureka": {
    "best": [{"to":"Имбирь"}],
