// v21.12.10 dataset — taxonomy unchanged; flavor data may be sparse
...
window.TAXONOMY = {
  ...
  "names": {
    ...
    "Mixto — Añejo": ["Sauza Añejo","Jose Cuervo Añejo","Сierra Añejo","El Jimador Аñejo","Olmeca (лимитированные)"],
    "Mixto — Extra Añejo": [],
...
// Минимальные реальные связи только для примера
window.FLAVOR_DATA = {
  "Цитрусовые": {
