// v21.12.7 dataset — same taxonomy as before with fuller FLAVOR_DATA for rendering
...
window.TAXONOMY = {
  ...
  "subgroups": {
    ...
    "Текила": ["100% агавы — Blanco / Plata","100% агавы — Joven / Cristалino","100% агавы — Reposado","100% агавы — Añejo","100% агавы — Extra Añejo","Mixto — Blanco / Silver","Mixto — Joven / Oro","Mixto — Reposado","Mixto — Añejo","Mixto — Extra Añejo"],
  ...
  "names": {
    ...
    "100% агавы — Joven / Cristалino": ["Maestro Dobel Diamante (Cristалino)","Jose Cuervo Tradicional Reposado Cristалino","1800 Cristалino","Cazadores Joven Cristалino","Volcán De Mi Tierra Cristалино"],
    ...
    "Mixto — Añejo": ["Sauza Añejo","Jose Cuervo Añejo","Sierra Añejo","El Jimador Аñejo","Olmeca (лимитированные)"],
    "Mixto — Extra Añejo": [],
...
window.FLAVOR_DATA = {
  "Цитрусовые": { "notes":"Лимонен/цитраль. Любят зелень, крестоцветные, белую рыбу.",
    "best":[{"to":"Кинза"},{"to":"Имбирь"},{"to":"Белая рыба"}],
